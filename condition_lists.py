...
temp=["Normal for season" for i in range(14)]+[f"{round((randint(1,4)*10)/1.8)}°C colder than normal" for i in range(3)]+[f"{round((randint(1,4)*10)/1.8)}°C hotter than normal" for i in range(3)]
